...
- **Warm-up in parallel.** `src/instrumentation.ts` in the Next.js repo pings this service's `/meta` as
  soon as Next.js starts (fire-and-forget, never awaited, because Next waits for that hook before
